...
describe('Feature: Price Alert — Celina 3', () => {
  ...
  it('Scenario 28: Kreiranje price alert-a sa uslovom BELOW vraća 201 i aktivan alert', () => {
    cy.request({
      method: 'POST',
      ...
      expect(body.condition ?? body.type, 'uslov mora biti BELOW').to.eq('BELOW');
      expect(Number(body.threshold ?? body.price), 'prag mora biti 300').to.eq(300);
